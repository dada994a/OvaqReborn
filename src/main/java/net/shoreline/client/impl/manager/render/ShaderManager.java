package net.shoreline.client.impl.manager.render;
...
public class ShaderManager implements Globals {
 ...
 private OvaqRebornFramebuffer shaderBuffer;
 ...
 public void renderShaders() {
  if (DEFAULT == null) {
   shaderBuffer = new OvaqRebornFramebuffer(mc.getFramebuffer().textureWidth, mc.getFramebuffer().textureHeight);
   reloadShaders();
  }
 ...
 public static class OvaqRebornFramebuffer extends Framebuffer {
  public OvaqRebornFramebuffer(int width, int height) {
   super(false);
   RenderSystem.assertOnRenderThreadOrInit();
